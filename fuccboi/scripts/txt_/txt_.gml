function txt_() {
	...
	txt("Skips,", "Rigby", RIGBY.SEVEN, SPRITEPOS.RIGHT), //show skips
	txt("even *Pops* has one.", "Rigby", RIGBY.SEVEN, SPRITEPOS.RIGHT), //show pops
	txt("Don't you feel like we're missing out on something?", "Rigby", RIGBY.SEVEN, SPRITEPOS.RIGHT),
