function __bktgtlich_ui_init() {
	...
	__bktgtlich_setup_property(prop.intensity, 1.86, "intensity", bktglitch_set_intensity, 0, 5);
	__bktgtlich_setup_property(prop.lineShift, 0.037, "lineShift", bktglitch_set_line_shift, 0, .05);
	__bktgtlich_setup_property(prop.lineResolution, .78,  "lineResolution", bktglitch_set_line_resolution, 0, 3);
	__bktgtlich_setup_property(prop.lineVertShift, .67, "lineVertShift", bktglitch_set_line_vertical_shift, 0, 1);
	__bktgtlich_setup_property(prop.lineSpeed, 0.43, "lineSpeed", bktglitch_set_line_speed, 0, .5);
	__bktgtlich_setup_property(prop.jumbleness, 0.68, "jumbleness", bktglitch_set_jumbleness, 0, 1);
	__bktgtlich_setup_property(prop.jumbleResolution, .008, "jumbleResolution", bktglitch_set_jumble_resolution, 0, 1);
	__bktgtlich_setup_property(prop.jumbleShift, 0.15, "jumbleShift", bktglitch_set_jumble_shift, 0, 1);
	__bktgtlich_setup_property(prop.jumbleSpeed, 22.0, "jumbleSpeed", bktglitch_set_jumble_speed, 0, 25);
	__bktgtlich_setup_property(prop.channelShift, 0.03, "channelShift", bktglitch_set_channel_shift, 0, .05);
	__bktgtlich_setup_property(prop.dispersion, 0.014, "dispersion", bktglitch_set_channel_dispersion, 0, .5);
	__bktgtlich_setup_property(prop.noiseLevel,  0.31, "noiseLevel", bktglitch_set_noise_level, 0, 1);
	__bktgtlich_setup_property(prop.lineDrift, 0.03,  "lineDrift", bktglitch_set_line_drift, 0, 1);
	__bktgtlich_setup_property(prop.shakiness, 0.7,  "shakiness", bktglitch_set_shakiness, 0, 10);
	__bktgtlich_setup_property(prop.rngSeed, .814175,  "rngSeed", bktglitch_set_rng_seed, 0, 1);
